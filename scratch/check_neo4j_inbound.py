...
with driver.session() as session:
    # Check ALL inbound relationships to this document
    ...
    inbound_all = [dict(r) for r in res]

with io.open('neo4j_inbound.txt', 'w', encoding='utf-8') as f:
    f.write(f'Inbound to 105/2016/QH13: {inbound_all}\n')
driver.close()
